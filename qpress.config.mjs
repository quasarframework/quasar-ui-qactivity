...
export default {
  api: {
    entries: [
      {
        docsUrl: '/developing/using-qactivity',
        input: 'packages/ui/src/components/QActivity.ts',
        output: 'packages/ui/dist/api/QActivity.json',
      },
      {
        docsUrl: '/developing/using-qactivity',
        input: 'packages/ui/src/components/QActivityItem.ts',
        output: 'packages/ui/dist/api/QActivityItem.json',
      },
    ],
  },
  check: {
