<template>
  <section class="landing-page markdown-brand">
    <header class="hero">
      <img src="/app-logo-128x128.png" alt="QActivity Logo" class="hero-logo" />
      <h1 class="hero-title">QActivity</h1>
      ...
      <div class="hero-buttons">
        ...
        <a
          href="https://github.com/quasarframework/quasar-ui-qactivity/tree/v3-beta"
          target="_blank"
    ...
    <div class="byline">
      <p>
        Build clean activity feeds, timelines, release notes, and story lists with a tiny pair of
        Quasar components.
      </p>
    </div>
    ...
    <div class="byline">
      <p>
        ...
        <a href="https://github.com/quasarframework/quasar-ui-qactivity" target="_blank">
          QActivity GitHub repo
        </a>
        and the
    ...
    <div class="byline">
      <p>
        ...
        assistance, please reach out through the QActivity repository or GitHub Discussions.
      </p>
    </div>
  </section>
</template>
