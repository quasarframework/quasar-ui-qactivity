...
You can contribute to the content on the QActivity site in a few different ways. Choose the way that works best for you.
...
Alternatively, you can fork the QActivity repo, make your changes and generate a Pull Request.
...
Please keep this in mind when writing content for QActivity:
