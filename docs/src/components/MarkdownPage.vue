    ...
    <div class="markdown-page__footer">
      ...
      <div v-if="path && noEdit !== true">
        <div class="full-width row justify-center items-center">
          ...
          <markdown-link
            :to="'https://github.com/quasarframework/quasar-ui-qactivity/edit/next/docs/src/pages' + path + '.md'"
          >
  ...
  setup (props) {
    ...
    useMeta(
      props.metaDesc !== void 0
        ? { title: props.metaTitle, meta: getMeta(props.metaTitle + ' » QActivity', props.metaDesc) }
