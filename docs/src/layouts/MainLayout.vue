<template>
  <q-layout view="HHh LpR fFf" @scroll="onScroll">
    ...
    <q-footer elevated class="glass">
      <q-toolbar>
        <div class="full-width text-center">This documentation site for QActivity is a work in progress. If you see something missing or inaccurate, please create a PR on the <markdown-link to="https://github.com/quasarframework/quasar-ui-qactivity/tree/next" style="color: white;">GitHub repo</markdown-link>.</div>
      </q-toolbar>
    </q-footer>
...
export default defineComponent({
  ...
  setup () {
    const path = ref(null),
      basePath = 'https://github.com/quasarframework/quasar-ui-qactivity/tree/next/docs/src/examples/',
      name = ref(null),
