...
const menu = [
  {
    name: 'All about QActivity',
    path: 'all-about-qactivity',
    expanded: false,
    children: [
      {
        name: 'What is QActivity',
        path: 'what-is-qactivity'
      },
      {
  ...
  },
  {
    ...
    children: [
      {
        name: 'Using QActivity',
        path: 'using-qactivity'
      }
    ]
  },
  {
    ...
    children: [
      {
        name: 'GitHub',
        external: true,
        path: 'https://github.com/quasarframework/quasar-ui-qactivity',
        rightIcon: biGithub
      },
      {
        name: 'Twitter',
