  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item clickable tag="a" target="_blank" href="https://github.com/quasarframework/app-extension-qactivity">
          <q-item-section avatar>
            <q-icon name="bolt" />
          </q-item-section>
          <q-item-section>
            <q-item-label>QActivity home</q-item-label>
            <q-item-label caption>@quasar/app-extension-qactivity</q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
